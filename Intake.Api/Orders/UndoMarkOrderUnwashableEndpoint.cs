...
public static class UndoMarkOrderUnwashableEndpoint
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var newOrder = order.UndoMarkUnwashable();
        unitOfWork.Transition<UnwashableOrder, UnwashedOrder, OrderId>(order, newOrder);
