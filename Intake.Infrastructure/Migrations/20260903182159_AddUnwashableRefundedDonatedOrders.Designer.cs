...
namespace Intake.Infrastructure.Migrations
{
    ...
    [Migration("20260903182159_AddUnwashableRefundedDonatedOrders")]
    partial class AddUnwashableRefundedDonatedOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intake.Domain.Orders.DonatedOrder", b =>
                {
                    b.HasBaseType("Intake.Domain.Orders.OrderBase");

                    b.HasDiscriminator().HasValue("Donated");
                });
            ...
            modelBuilder.Entity("Intake.Domain.Orders.RefundedOrder", b =>
                {
                    b.HasBaseType("Intake.Domain.Orders.OrderBase");

                    b.HasDiscriminator().HasValue("Refunded");
                });
            ...
            modelBuilder.Entity("Intake.Domain.Orders.UnwashableOrder", b =>
                {
                    b.HasBaseType("Intake.Domain.Orders.OrderBase");

                    b.HasDiscriminator().HasValue("Unwashable");
                });
